...
public class StorageService {
    ...
    public List<String> uploadImages(List<MultipartFile> files) throws IOException {
        ...
        for (MultipartFile file : files) {
            ...
            if (imageData != null) {
                uploadedFileMessages.add("File uploaded successfully: " + file.getOriginalFilename());
            } else {
                uploadedFileMessages.add("Failed to upload: " + file.getOriginalFilename());
            }
        }

        return uploadedFileMessages;
    }
}
